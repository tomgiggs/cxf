...
public interface QqOnlineWebServiceSoap {
    ...
    @RequestWrapper(localName = "qqCheckOnline", targetNamespace = "http://WebXml.com.cn/", className = "com.jxjr.ynzw.qqclient.QqCheckOnline")
    @ResponseWrapper(localName = "qqCheckOnlineResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.jxjr.ynzw.qqclient.QqCheckOnlineResponse")
